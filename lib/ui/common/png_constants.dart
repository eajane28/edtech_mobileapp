class PngConstants {
  ...
  static const String illustration = "${_rootPath}Illustration.png";
  static const String study = "${_rootPath}Cool Kids Study.png";
  static const String bike = "${_rootPath}bike.png";
  static const String alone = "${_rootPath}Illustration.png";
}
